...
class LocalJsonIO():
    ...
    def write_json_ctx(self, ctx: dict=None, use_right_side: bool=False):
        """
        ...
        if not context_data:
            context_data = {'context': [{'position': 'right'}, {'position': 'left'}]}
    ...
    def read_json_ctx(self, use_right_side: bool=False, full_json: bool=False):
        """
