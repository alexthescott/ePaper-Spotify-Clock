...
class Clock():
    ...
    def build_image(self):
        ...
        name_width_1, name_height_1 = self.image_obj.draw_name(self.name_1, 210, 0)
        ...
        if not self.single_user:
            ...
            name_width_2, name_height_2 = self.image_obj.draw_name(self.name_2, 8, 0)
    ...
    def get_time_from_date_time(self, old_min):
